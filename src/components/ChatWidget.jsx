...
export default function ChatWidget({
  ...
  async function handleSubmit(e) {
    ...
    if (!mcpServerId) {
      setError('No MCP server configured for this chat widget.');
      return;
    }
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      {open && (
        <div className="mb-4 w-80 sm:w-96 h-[28rem] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden">
          {/* Header */}
